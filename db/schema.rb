...
ActiveRecord::Schema[7.1].define(version: 2025_03_24_142147) do
  ...
  create_table "symptoms", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["beverage_entry_id"], name: "index_symptoms_on_beverage_entry_id"
  end
  ...
  add_foreign_key "symptoms", "beverage_entries"
end
